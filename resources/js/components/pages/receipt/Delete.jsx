...
export default function Delete(props) {
	...
	return (
		...
		>
			<h2 className="text-lg font-medium leading-6 text-gray-900 text-center"> Mã: {props.data.code} </h2>
			<p className="mt-2 text-gray-700 text-center"> Bạn có chắc chắn muốn xóa hóa đơn này không? </p>
