...
return [
    ...
    */
    ...
    'accepted'              => 'Vui lòng đồng ý với :attribute',
    ...
    'digits'                => ':attribute gồm 10 chữ số',
    ...
    'max' => [
        ...
        'file'              => ':attribute không lớn hơn kB.',
    ...
    'mimes'                 => ':attribute phải là tệp tin dạng :values.',
    'mimetypes'             => ':attribute field must be a file of type: :values.',
    'min' => [
        'array'             => ':attribute cần ít nhất :min .',
    ...
    'numeric'               => ':attribute chỉ chứa chữ số.',
    'password' => [
    ...
    'uppercase_and_number'  => ':attribute chỉ bao gồm chữ in hoa và số',
