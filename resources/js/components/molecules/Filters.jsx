                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            type="text"
                            id="search"
                            className="block h-10 pr-2 pl-4 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 pe-5" placeholder="Tìm kiếm"
                        />
                    </div>
                </div>
            }
