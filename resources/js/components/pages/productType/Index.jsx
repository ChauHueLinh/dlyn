...
import Add from '~/components/pages/productType/Add'
import Edit from '~/components/pages/productType/Edit'
import Delete from '~/components/pages/productType/Delete'
...
if (document.getElementById("product-type-index")) {
    ReactDOM.createRoot(document.getElementById("product-type-index")).render (
