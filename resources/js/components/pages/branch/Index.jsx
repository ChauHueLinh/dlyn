...
import Add from '~/components/pages/branch/Add'
import Edit from '~/components/pages/branch/Edit'
import Delete from '~/components/pages/branch/Delete'
            ...
            >
                {lists?.data?.map((item, index) => (
                    <tr key={index} className="bg-white border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td className="p-3">
                            <img className='rounded-2' style={{width:'40px', height: '40px', minWidth: '40px'}} src={item.image} alt="avatar"/>
                        </td>
                        <td className="p-3">
                            {item.name}
                        </td>
...
if (document.getElementById("branch-index")) {
    ReactDOM.createRoot(document.getElementById("branch-index")).render (
